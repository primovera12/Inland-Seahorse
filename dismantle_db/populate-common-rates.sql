...
-- ============================================================
-- Run this in your Supabase SQL Editor AFTER your schema and seed data are loaded
-- This creates ~250+ common equipment combinations with NULL prices
-- so you can quickly fill them in using the Price Entry view
-- ============================================================
...
-- VERIFICATION QUERY
-- ============================================================
-- This shows how many rates were pre-populated
SELECT
...
SELECT
  'Breakdown by equipment type:' as info,
