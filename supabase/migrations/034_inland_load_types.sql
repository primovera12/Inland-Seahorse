...
CREATE INDEX IF NOT EXISTS idx_inland_load_types_active ON inland_load_types(is_active);
CREATE INDEX IF NOT EXISTS idx_inland_load_types_sort ON inland_load_types(sort_order);
